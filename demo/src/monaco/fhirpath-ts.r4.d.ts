...
interface Address extends Element$1 {
	city?: string;
	country?: string;
	district?: string;
	extension?: Extension[];
...
interface Annotation extends Element$1 {
...
interface Attachment extends Element$1 {
	contentType?: string;
	creation?: string;
	data?: string;
	extension?: Extension[];
...
interface BackboneElement extends Element$1 {
	extension?: Extension[];
	id?: string;
	modifierExtension?: Extension[];
}
interface CodeableConcept extends Element$1 {
	coding?: Coding[];
	extension?: Extension[];
	id?: string;
	text?: string;
}
interface Coding extends Element$1 {
	code?: string;
	display?: string;
	extension?: Extension[];
	id?: string;
...
interface ContactDetail extends Element$1 {
	extension?: Extension[];
	id?: string;
	name?: string;
	telecom?: ContactPoint[];
}
interface ContactPoint extends Element$1 {
	extension?: Extension[];
	id?: string;
	period?: Period;
	rank?: number;
...
interface Contributor extends Element$1 {
...
interface DataRequirement extends Element$1 {
...
interface DataRequirementCodeFilter extends Element$1 {
	code?: Coding[];
	extension?: Extension[];
	id?: string;
	path?: string;
...
interface DataRequirementDateFilter extends Element$1 {
	extension?: Extension[];
	id?: string;
	path?: string;
	searchParam?: string;
...
interface DataRequirementSort extends Element$1 {
	direction?: string;
	extension?: Extension[];
	id?: string;
	path?: string;
...
interface DosageDoseAndRate extends Element$1 {
	doseRange?: Range$1;
...
interface ElementDefinitionBase extends Element$1 {
	extension?: Extension[];
	id?: string;
	max?: string;
	min?: number;
...
interface ElementDefinitionBinding extends Element$1 {
	description?: string;
	extension?: Extension[];
	id?: string;
	strength?: string;
...
interface ElementDefinitionConstraint extends Element$1 {
	expression?: string;
	extension?: Extension[];
	human?: string;
	id?: string;
...
interface ElementDefinitionExample extends Element$1 {
	extension?: Extension[];
	id?: string;
	label?: string;
...
interface ElementDefinitionMapping extends Element$1 {
	comment?: string;
	extension?: Extension[];
	id?: string;
	identity?: string;
...
interface ElementDefinitionSlicing extends Element$1 {
	description?: string;
...
interface ElementDefinitionSlicingDiscriminator extends Element$1 {
	extension?: Extension[];
	id?: string;
	path?: string;
	type?: string;
}
interface ElementDefinitionType extends Element$1 {
	aggregation?: string[];
	code?: string;
	extension?: Extension[];
	id?: string;
...
interface Expression extends Element$1 {
	description?: string;
	expression?: string;
	extension?: Extension[];
	id?: string;
...
interface Extension extends Element$1 {
	extension?: Extension[];
	id?: string;
	url?: string;
	valueBase64Binary?: string;
...
interface HumanName extends Element$1 {
	extension?: Extension[];
	family?: string;
	given?: string[];
	id?: string;
...
interface Identifier extends Element$1 {
	assigner?: Reference;
	extension?: Extension[];
	id?: string;
	period?: Period;
...
interface Meta extends Element$1 {
	account?: Reference;
	accounts?: Reference[];
	author?: Reference;
...
interface Money extends Element$1 {
	currency?: string;
	extension?: Extension[];
	id?: string;
	value?: number;
...
interface Narrative extends Element$1 {
	div?: string;
	extension?: Extension[];
	id?: string;
	status?: string;
}
interface ParameterDefinition extends Element$1 {
...
interface Period extends Element$1 {
	end?: string;
	extension?: Extension[];
	id?: string;
	start?: string;
...
interface Quantity extends Element$1 {
	code?: string;
	comparator?: string;
	extension?: Extension[];
	id?: string;
...
interface Range$1 extends Element$1 {
	extension?: Extension[];
	high?: Quantity;
	id?: string;
	low?: Quantity;
}
interface Ratio extends Element$1 {
	denominator?: Quantity;
	extension?: Extension[];
	id?: string;
	numerator?: Quantity;
}
interface Reference extends Element$1 {
	display?: string;
	extension?: Extension[];
	id?: string;
	identifier?: Identifier;
...
interface RelatedArtifact extends Element$1 {
	citation?: string;
	display?: string;
	document?: Attachment;
	extension?: Extension[];
...
interface SampledData extends Element$1 {
	data?: string;
	dimensions?: number;
	extension?: Extension[];
	factor?: number;
...
interface Signature extends Element$1 {
	data?: string;
	extension?: Extension[];
	id?: string;
	onBehalfOf?: Reference;
...
interface SubstanceAmountReferenceRange extends Element$1 {
	extension?: Extension[];
	highLimit?: Quantity;
	id?: string;
	lowLimit?: Quantity;
...
interface TimingRepeat extends Element$1 {
...
interface TriggerDefinition extends Element$1 {
...
interface UsageContext extends Element$1 {
	code?: Coding;
	extension?: Extension[];
	id?: string;
	valueCodeableConcept?: CodeableConcept;
...
interface CompositionEvent$1 extends BackboneElement {
	code?: CodeableConcept[];
	detail?: Reference[];
	extension?: Extension[];
	id?: string;
...
interface DeviceDefinitionClassification extends BackboneElement {
	extension?: Extension[];
	id?: string;
...
interface EvidenceVariableCharacteristic extends BackboneElement {
	...
	durationRange?: Range$1;
	exclude?: boolean;
	extension?: Extension[];
	id?: string;
	instancesQuantity?: Quantity;
	instancesRange?: Range$1;
	linkId?: string;
	modifierExtension?: Extension[];
	note?: Annotation[];
	timeFromEvent?: EvidenceVariableCharacteristicTimeFromEvent[];
}
interface EvidenceVariableCharacteristicDefinitionByCombination extends BackboneElement {
	characteristic?: EvidenceVariableCharacteristic[];
	code?: string;
	extension?: Extension[];
	id?: string;
...
interface EvidenceVariableCharacteristicDefinitionByTypeAndValue extends BackboneElement {
	device?: Reference;
	extension?: Extension[];
	id?: string;
	method?: CodeableConcept[];
...
interface EvidenceVariableCharacteristicTimeFromEvent extends BackboneElement {
	description?: string;
...
interface Location$1 extends DomainResource {
...
interface Parameters$1 extends Resource {
...
interface ResearchStudyAssociatedParty extends BackboneElement {
	classifier?: CodeableConcept[];
	extension?: Extension[];
	id?: string;
	modifierExtension?: Extension[];
...
interface ResearchStudyComparisonGroup extends BackboneElement {
	description?: string;
	extension?: Extension[];
	id?: string;
...
interface ResearchStudyLabel extends BackboneElement {
	extension?: Extension[];
	id?: string;
	modifierExtension?: Extension[];
	type?: CodeableConcept;
...
interface ResearchStudyOutcomeMeasure extends BackboneElement {
	description?: string;
	extension?: Extension[];
	id?: string;
	modifierExtension?: Extension[];
...
interface ResearchStudyProgressStatus extends BackboneElement {
	actual?: boolean;
	extension?: Extension[];
	id?: string;
	modifierExtension?: Extension[];
...
interface ResearchStudyRecruitment extends BackboneElement {
...
interface SubscriptionStatus extends DomainResource {
...
interface SubscriptionStatusNotificationEvent extends BackboneElement {
...
interface R4Elements {
	...
	ElementDefinition: {
		...
		defaultValue: {
			t: "base64Binary" | "boolean" | "canonical" | "code" | "date" | "dateTime" | "decimal" | "id" | "instant" | "integer" | "markdown" | "oid" | "positiveInt" | "string" | "time" | "unsignedInt" | "uri" | "url" | "uuid" | "Address" | "Age" | "Annotation" | "Attachment" | "CodeableConcept" | "Coding" | "ContactPoint" | "Count" | "Distance" | "Duration" | "HumanName" | "Identifier" | "Money" | "Period" | "Quantity" | "Range" | "Ratio" | "Reference" | "SampledData" | "Signature" | "Timing" | "ContactDetail" | "Contributor" | "DataRequirement" | "Expression" | "ParameterDefinition" | "RelatedArtifact" | "TriggerDefinition" | "UsageContext" | "Dosage" | "Meta";
			a: false;
		};
		definition: {
			t: "markdown";
	...
	"Contract.term.offer.answer": {
		...
		value: {
			t: "boolean" | "decimal" | "integer" | "date" | "dateTime" | "time" | "string" | "uri" | "Attachment" | "Coding" | "Quantity" | "Reference";
			a: false;
		};
	};
	...
	Observation: {
		...
		value: {
			t: "Quantity" | "CodeableConcept" | "string" | "boolean" | "integer" | "Range" | "Ratio" | "SampledData" | "time" | "dateTime" | "Period";
			a: false;
		};
	};
...
interface R4TypeOf {
	...
	"Composition.event": CompositionEvent$1;
...
type Navigate<S extends State, E extends string> = ElementInfo<S["n"], E> extends {
	t: infer N extends string;
	a: infer A extends boolean;
} ? {
	n: N;
	many: S["many"] extends true ? true : A;
} : "opaque";
type StripCount<S extends string> = S extends `${infer N}[${string}]` ? N : S;
type Step<S extends State | "opaque", Seg extends string> = S extends State ? Seg extends `where(${string})` ? S : Seg extends `ofType(${infer T})` | `as(${infer T})` ? T extends keyof R4TypeOf & string ? {
	n: T;
	many: S["many"];
} : "opaque" : Seg extends "first()" | "last()" | "single()" ? {
	n: S["n"];
	many: false;
	...
	n: "integer";
	many: false;
} : Seg extends `select(${infer Inner})` ? ParseSegments<Inner, {
	n: S["n"];
	many: false;
}> extends infer Projected ? Projected extends State ? {
	n: Projected["n"];
	many: true;
} : "opaque" : "opaque" : Seg extends `${string}(${string})` | `${string}()` ? "opaque" : Seg extends `${infer N}[${string}]` ? Navigate<S, StripCount<N>> extends infer Indexed ? Indexed extends State ? {
	n: Indexed["n"];
	many: false;
} : "opaque" : "opaque" : Navigate<S, Seg> : "opaque";
type ParseSegments<Expr extends string, S extends State | "opaque"> = Expr extends "" ? S : Expr extends `${infer Head}.${infer Rest}` ? Head extends `${string}(` | `${string}(${string}` ? StepAcrossParen<Expr, S> : ParseSegments<Rest, Step<S, Head>> : Step<S, Expr>;
type StepAcrossParen<Expr extends string, S extends State | "opaque"> = Expr extends `${infer Head})${""}` ? Step<S, `${Head})`> : Expr extends `${infer Head}).${infer Rest}` ? Head extends `${string})${string}` ? "opaque" : ParseSegments<Rest, Step<S, `${Head})`>> : "opaque";
type ParseRoot<Expr extends string> = Expr extends `${infer Root}.${infer Rest}` ? Root extends keyof R4Resources & string ? ParseSegments<Rest, {
	n: Root;
	many: false;
}> : "opaque" : Expr extends keyof R4Resources & string ? {
	n: Expr;
	many: false;
} : "opaque";
type ResultOf<S extends State | "opaque"> = S extends State ? S["n"] extends keyof R4TypeOf ? R4TypeOf[S["n"]][] : unknown[] : unknown[];
type FhirpathResult<Expr extends string> = string extends Expr ? unknown[] : ResultOf<ParseRoot<Expr>>;
type FhirpathInput<Expr extends string> = string extends Expr ? unknown : Expr extends `${infer Root}.${string}` ? Root extends keyof R4Resources ? R4Resources[Root] : unknown : Expr extends keyof R4Resources ? R4Resources[Expr] : unknown;
...
declare const FHIR_PRIMITIVE_TO_SYSTEM: Readonly<Record<string, string>>;
interface ElementInfo$1 {
...
interface ModelProvider {
	...
	getElement(type: string, element: string): ElementInfo$1 | undefined;
...
type BinaryOperator = "*" | "/" | "div" | "mod" | "+" | "-" | "&" | "|" | "<" | ">" | "<=" | ">=" | "=" | "~" | "!=" | "!~" | "in" | "contains" | "and" | "or" | "xor" | "implies";
type UnaryOperator = "+" | "-";
...
interface NullLiteralNode extends BaseNode {
	kind: "null";
}
...
interface DateLiteralNode extends BaseNode {
	kind: "date";
	/** Literal text without the `@`, e.g. `2014-01`. */
	text: string;
}
interface DateTimeLiteralNode extends BaseNode {
	kind: "dateTime";
	/** Literal text without the `@`, e.g. `2014-01-25T14:30:00Z` or `2014T`. */
	text: string;
}
interface TimeLiteralNode extends BaseNode {
	kind: "time";
	/** Literal text without the `@T`, e.g. `14:30`. */
	text: string;
}
interface QuantityLiteralNode extends BaseNode {
	kind: "quantity";
	value: string;
	unit: string;
...
interface SpecialVariableNode extends BaseNode {
	kind: "special";
	name: "this" | "index" | "total";
}
interface ExternalConstantNode extends BaseNode {
	kind: "external";
	name: string;
}
...
interface TypeOpNode extends BaseNode {
	kind: "typeOp";
	operator: "is" | "as";
	operand: AstNode;
	type: TypeSpecifier;
}
type AstNode = NullLiteralNode | BooleanLiteralNode | StringLiteralNode | NumberLiteralNode | DateLiteralNode | DateTimeLiteralNode | TimeLiteralNode | QuantityLiteralNode | IdentifierNode | SpecialVariableNode | ExternalConstantNode | DotNode | IndexerNode | FunctionCallNode | UnaryNode | BinaryNode | TypeOpNode;
...
interface ConstraintCheckResult {
	...
	toOperationOutcome(): OperationOutcome$1;
}
...
type EngineInput<Expr extends string = string> = FhirpathInput<Expr> | readonly unknown[] | BundleLike;
...
declare class BoundExpression<Expr extends string = string> {
...
export {
	FHIR_PRIMITIVE_TO_SYSTEM as PRIMITIVE_TO_SYSTEM,
};
