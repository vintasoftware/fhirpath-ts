...
await emit('types-data.ts', 'R4_DATA_TYPES', dataTypes.types, 'profiles-types.json')
await emit('resources-data.ts', 'R4_RESOURCES', resources.types, 'profiles-resources.json')
